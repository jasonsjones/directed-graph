/**
 * @fileOverview Implementation of a directed graph data structure
...
(function() {
    ...
    /**
     * Creates a new Directed Graph instance using the theVerts to provide the
     ...
     *
     */
    DiGraph.prototype.addVertex = function (label) {
     ...
     *
     */
    DiGraph.prototype.addEdge = function (v1, v2, w) {
        if (this.adjacentList.has(v1)) {
            var edgeWeight = w || 1;
     ...
     *
     */
    DiGraph.prototype.BFS = function(vertex) {
        var q = new Queue();
        var result = [];
        var visited = [];
     ...
     *
     */
    DiGraph.prototype.DFS = function(vertex) {
        var stack = new Stack();
        var result = [];
        var visited = [];
     ...
     *
     */
    DiGraph.prototype.shortestPath = function (label) {
        var q = new Queue();
        var visited = [];
        var dist = [];
        var pred = [];
